...
AZURE_AD_GROUP_NAME="labor-aks-group"
CURRENT_USER_OBJECTID=$(az ad signed-in-user show --query id -o tsv 2> /dev/null)
...
AZURE_GROUP_ID=$(az ad group show --group $AZURE_AD_GROUP_NAME --query id -o tsv 2> /dev/null)
